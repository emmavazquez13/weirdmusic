  ...
  return (
    <div className="flex w-screen main-chat lg:h-screen bg-gray-900 divide-solid">
      ...
      <div className="flex w-full lg:w-5/6 lg:h-5/6 lg:mx-auto lg:my-auto shadow-md">
        {/* Users online */}
        <div className="hidden lg:block pl-4 pr-4 w-64 bg-red text-white">
        ...
        <div className="flex flex-col flex-grow lg:max-w-full bg-red-50">
          {/* Messages */}
              ...
              {chat.map((el, index) => (
                ...
                >
                  {el.nickname != null ? (
                    ...
                    <p className="text-base font-semibold text-red rounded py-1">
                      {el}
                    </p>
                  )}
                </li>
            ...
            <div className="w-full flex p-4 lg:p-8 bg-red-50">
              ...
              <div className="flex relative w-full lg:w-5/6">
                <span className="rounded-l-md inline-flex items-center px-1 lg:px-3 border-t bg-white border-l border-b  border-gray-300 text-gray-500 shadow-sm text-sm">
                  {toUser === "" ? (
                    <p className="bg-red text-white text-xs lg:text-base font-normal rounded p-1">
                      To: Everyone
                    </p>
                  ) : (
                    <p className="bg-red text-white text-xs lg:text-base font-semibold rounded p-1 w-20 lg:w-28 truncate">
                      To: {toUser}
                    </p>
                  )}
                </span>
