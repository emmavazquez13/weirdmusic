...
export default function Login() {
  ...
  return (
    ...
    //         <input
    //           type='username'
    //           className='block w-full px-4 py-2 mt-2 text-gray-dark bg-white border rounded-md focus:border-red focus:ring-red focus:outline-none focus:ring focus:ring-opacity-40'
    //         />
    //       </div>
    //       <div className='mb-2'>
    //         <label
    ...
    //         />
    //       </div>
    //       <a href='#' className='text-xs text-red hover:underline'>
    //         Forget Password?
    //       </a>
    //       <div className='mt-6'>
    ...
    //       <button
    //         type='button'
    //         className='flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-red'
    //       >
    //         <svg
    ...
    //         </svg>
    //       </button>
    //       <button className='flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-red'>
    //         <svg
    //           xmlns='http://www.w3.org/2000/svg'
    //           viewBox='0 0 32 32'
    //           className='w-5 h-5 fill-current'
